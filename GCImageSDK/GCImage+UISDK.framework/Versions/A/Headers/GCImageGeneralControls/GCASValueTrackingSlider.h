...
@protocol GCASValueTrackingSliderDelegate;
@protocol GCASValueTrackingSliderDataSource;

@interface GCASValueTrackingSlider : UISlider
...
@property (weak, nonatomic) id<GCASValueTrackingSliderDataSource> dataSource;

// delegate is only needed when used with a TableView or CollectionView - see below
@property (weak, nonatomic) id<GCASValueTrackingSliderDelegate> delegate;
@end
...
@protocol GCASValueTrackingSliderDataSource <NSObject>
- (NSString *)slider:(GCASValueTrackingSlider *)slider stringForValue:(float)value;
@end
...
@protocol GCASValueTrackingSliderDelegate <NSObject>
- (void)sliderWillDisplayPopUpView:(GCASValueTrackingSlider *)slider;

@optional
- (void)sliderDidHidePopUpView:(GCASValueTrackingSlider *)slider;
@end
