...
/*!
 *  @brief  The class for control panel with a iOS blur effect. It usually contains a group of controls to
 *          change parameters of a image filter.
 *
 *  @since v1.0.0
 */
@interface GCBlurOverlayView : GCOverlayView

/*!
 *  @brief  The initialization method.
 *
 *  @param frame     The frame of the control panel.
 *  @param superview The superview of the control panel.
 *  @param image     The background image for iOS blur effect.
 *
 *  @return The instance of GCBlurOverlayView.
 *
 *  @since v1.0.0
 */
- (instancetype)initWithFrame:(CGRect)frame superview:(UIView *)superview image:(UIImage *)image;
